...
export const data = [
    {id: 1, name: "lorem ipsum", price: 75.00, img: test, new: false, sale: true, newprice: 45.00, category: "Kids", inbasket: false}, 
    {id: 2, name: "lorem ipsum", price: 75.00, img: item4, new: false, sale: false, newprice: "", category: "Accessories", inbasket: false},
    {id: 3, name: "lorem ipsum", price: 75.00, img: item15, new: true, sale: false, newprice: "", category: "Accessories", inbasket: false}, 
